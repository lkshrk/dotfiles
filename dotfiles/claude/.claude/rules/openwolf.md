...
- PRECONDITION: apply these rules ONLY inside a git repo (`git rev-parse --is-inside-work-tree` succeeds). In a non-git dir, do NOT create or write any .wolf/ files — OpenWolf is disabled, skip all rules below.
